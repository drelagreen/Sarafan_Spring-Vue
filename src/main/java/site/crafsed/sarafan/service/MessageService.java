...
import site.crafsed.sarafan.dto.MetaDto;
import site.crafsed.sarafan.dto.ObjectType;
import site.crafsed.sarafan.repo.MessageRepo;
import site.crafsed.sarafan.repo.UserSubscriptionRepo;
...
public class MessageService {
    ...
    @Autowired
    public MessageService(MessageRepo messageRepo, UserSubscriptionRepo subscriptionRepo, WsSender wsSender) {
        this.messageRepo = messageRepo;
        this.userSubscriptionRepo = subscriptionRepo;
    ...
    private void fillMeta(Message message) throws IOException {
        ...
        if (matcher.find()) {
            ...
            matcher = IMG_REGEX.matcher(text);
